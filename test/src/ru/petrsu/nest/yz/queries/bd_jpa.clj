...
(ns ru.petrsu.nest.yz.queries.bd-jpa
  ...
  (:import (ru.petrsu.nest.son.jpa SON Building Room Floor
                                   Device, IPNetwork, EthernetInterface, 
                                   IPv4Interface, LinkInterface,
...
(def rootDevice (doto (Device.) 
                  ...
                  (.addLinkInterface (LinkInterface.))))
...
;; Specify EntityManager.
(def jpa-em 
  (create-em "nest-old" 
             {"hibernate.connection.url" "jdbc:h2:mem:db;DB_CLOSE_DELAY=-1;MVCC=TRUE;create=true"
              "hibernate.dialect" "org.hibernate.dialect.H2Dialect"
              "hibernate.connection.driver_class" "org.h2.Driver"
              "hibernate.hbm2ddl.auto" "create-drop"}))

;; Persist the son to the jpa EntityManager
(doto jpa-em
